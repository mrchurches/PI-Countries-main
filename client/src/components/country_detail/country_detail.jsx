...
export default function CountryDetail() {
  ...
  useEffect(() => {
    setTimeout(() => {
      axios.get(`${process.env.REACT_APP_API_URL}api/countries/${id}`)
        ...
        <div className={style.cont}>
          ...
          <div className={style.details}>
            ...
            <div className={style.activity}>
              {countries.activities.length ? countries.activities.map((e,i) => {
                return (
                  <div className={style.act_cont} key={`${e.name}${i}`}>
                    <h4>{e.name}</h4>
                    <hr />
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-arrow-left-square" viewBox="0 0 16 16">
